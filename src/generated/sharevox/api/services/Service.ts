...
export class Service {
     ...
     * @throws ApiError
     */
    public static connectWavesConnectWavesPost(
     ...
     * @throws ApiError
     */
    public static addPresetAddPresetPost(
        requestBody: Preset,
     ...
     * @throws ApiError
     */
    public static updatePresetUpdatePresetPost(
        requestBody: Preset,
    ): CancelablePromise<number> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static deletePresetDeletePresetPost(
        id: number,
     ...
     * @throws ApiError
     */
    public static speakersSpeakersGet(
        coreVersion?: string,
     ...
     * @throws ApiError
     */
    public static downloadableLibrariesDownloadableLibrariesGet(): CancelablePromise<Array<DownloadableLibrary>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static postSvModelSvModelPost(
        requestBody: SVModelInfo,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/sv_model',
