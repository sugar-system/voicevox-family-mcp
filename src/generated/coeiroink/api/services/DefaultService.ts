...
export class DefaultService {
   ...
   * @throws ApiError
   */
  public static getSpeakersV1SpeakersPathVariantGet(): CancelablePromise<
    Array<SpeakerMetaPathVariant>
  > {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static predictV1PredictPost(requestBody: WavMakingParam): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/v1/predict',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static processV1ProcessPost(requestBody: WavProcessingParam): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/v1/process',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static synthesisV1SynthesisPost(requestBody: SynthesisParam): CancelablePromise<Blob> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/v1/synthesis',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getDownloadableSpeakersV1DownloadableSpeakersGet(): CancelablePromise<
    Array<DownloadableSpeaker>
  > {
    return __request(OpenAPI, {
      method: 'GET',
