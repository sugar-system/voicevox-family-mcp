...
var EngineClient = class {
  ...
  async post(endpoint, data, params, options) {
    try {
      ...
      const response = await axios_default.post(url3, data, {
        params,
        responseType: (options == null ? void 0 : options.responseType) === "arraybuffer" ? "arraybuffer" : "json"
      });
...
// src/api/voiceSynthesisService.ts
...
var VoiceSynthesisService = class _VoiceSynthesisService {
  ...
  static create(baseUrl) {
    ...
    return new _VoiceSynthesisService(engineClient);
  }
  /**
  ...
  async createAudioQuery(params) {
    try {
      const result = await this.engineClient.post("/audio_query", null, {
        text: params.text,
  ...
  async synthesizeSpeech(params) {
    try {
      const audioData = await this.engineClient.post(
        "/synthesis",
        params.query,
        {
          speaker: params.speaker
  ...
  async getSpeakers() {
    try {
      return await this.engineClient.get("/speakers");
    } catch (error) {
...
// src/core/tools/tool-factory.ts
...
// src/core/tools/speak-response.ts
function createSpeakResponseFactory(voiceService, config) {
  ...
  const speakRequestParamsSchema = z.object({
    ...
    style_weight: z.number().default(1),
    ...
    assist_text_weight: z.number().default(1)
  });
  const speakResponseHandler = async (params, _extra) => {
    try {
  ...
  return new ToolFactory(
    "speak_response",
    "TTS\u30B5\u30FC\u30D0\u306B\u3088\u308A\u5408\u6210\u3057\u305F\u97F3\u58F0\u3092\u518D\u751F\u3057\u307E\u3059\u3002\u5229\u7528\u53EF\u80FD\u306A\u8A71\u8005ID\u306F\u300Clist_speakers\u300D\u30C4\u30FC\u30EB\u3067\u53D6\u5F97\u3067\u304D\u307E\u3059\u3002",
    speakRequestParamsSchema.shape,
    speakResponseHandler
  );
}

// src/core/tools/list-speakers.ts
function createListSpeakersFactory(voiceService) {
  const listSpeakersSchema = z.object({});
  const listSpeakersHandler = async (_params, _extra) => {
    try {
  ...
  function formatSpeakerInfo(speaker) {
...
var VoiceMcpServer = class _VoiceMcpServer {
  mcp;
  voiceService;
  config;
  toolFactories = [];
   ...
   */
  registerdTools = /* @__PURE__ */ new Map();
  constructor(config, voiceService) {
    this.config = config;
  ...
  static create(config) {
    ...
    return new _VoiceMcpServer(config, voiceService);
  }
  /**
   * サーバーを起動する
   */
  async start() {
    ...
    console.error(`\u{1F50C} Connected to ${this.config.engineType} engine at: ${this.config.engineUrl}`);
  }
  /**
  ...
  getToolHandler(name) {
    var _a;
    return (_a = this.registerdTools.get(name)) == null ? void 0 : _a.callback;
  }
};
...
if (argv.help) {
  console.error(`
\u{1F3A4} Voice MCP Server - Command Line Options \u{1F3A4}
...
console.error(`\u{1F3B5} Voice MCP Server \u3092\u8D77\u52D5\u3057\u307E\u3059`);
console.error(`\u{1F50D} \u30A8\u30F3\u30B8\u30F3\u7A2E\u985E: ${argv.engine}`);
console.error(`\u{1F517} \u30A8\u30F3\u30B8\u30F3URL: ${argv.url}`);
...
startServer().catch((error) => {
  console.error("\u{1F631} MCP\u30B5\u30FC\u30D0\u30FC\u306E\u8D77\u52D5\u306B\u5931\u6557\u3057\u307E\u3057\u305F:", error);
  process.exit(1);
});
